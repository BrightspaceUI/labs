...
const sauceLabsCapabilities = {
	name: '@brightspace-ui-labs/grade-result unit tests',
	// eslint-disable-next-line no-undef
	build: `@brightspace-ui-labs/grade-result ${process.env.GITHUB_REF ?? 'local'} build ${process.env.GITHUB_RUN_NUMBER ?? ''}`
};
