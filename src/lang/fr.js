export default {
	...
	"components:mediaPlayer:loadErrorMessage": "Oups, il y a eu un problème lors du chargement de ce fichier multimédia",
	"components:mediaPlayer:loadSuccessMessage": "Chargement du contenu multimédia réussi",
	"components:mediaPlayer:menu": "menu",
	"components:mediaPlayer:mute": "Silence",
	...
	"components:mediaPlayer:unableToDownload": "Impossible de télécharger. Veuillez rafraichir la page et réessayer.",
	"components:mediaPlayer:unmute": "Annuler silence",
	...
	"components:ouFilter:treeSelector:loadMoreLabel": "En voir plus",
	...
	"components:ouFilter:treeSelector:parentLoadMore:ariaLabel": "Charger plus d’unités organisationnelles enfants",
	"components:ouFilter:treeSelector:searchLoadMore:ariaLabel": "Charger plus de résultats de la recherche",
	"components:ouFilter:treeSelector:searchPlaceholder": "Recherche…",
	"components:ouFilter:treeSelector:dropdownAction": "Ouvrir le filtre {name}",
	"components:ouFilter:treeSelector:arrowLabel:closed": "Développer {name} au niveau {level}, enfant de {parentName}",
	"components:ouFilter:treeSelector:arrowLabel:open": "Réduire {name} au niveau {level}, enfant de {parentName}",
	"components:ouFilter:treeSelector:node:ariaLabel": "{name}, enfant de {parentName},",
