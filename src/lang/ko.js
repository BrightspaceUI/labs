export default {
	...
	"components:mediaPlayer:off": "비활성",
	...
	"components:ouFilter:treeSelector:arrowLabel:closed": "{level}에서 {parentName}의 하위 수준 {name} 확장",
	"components:ouFilter:treeSelector:arrowLabel:open": "{level}에서 {parentName}의 하위 수준 {name} 축소",
	"components:ouFilter:treeSelector:node:ariaLabel": "{parentName}의 하위 수준 {name}",
