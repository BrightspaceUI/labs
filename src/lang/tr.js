export default {
	...
	"components:attributePicker:removeValue": "{value} değerini kaldırmak için tıklayın", // Label for screen readers to inform user that they can click to remove the given value
