export default {
	...
	"components:attributePicker:removeValue": "मान {value} निकालने के लिए क्लिक करें", // Label for screen readers to inform user that they can click to remove the given value
