...
const childViewFixture = html`
	<d2l-menu label="Astronomy" style="width: 300px;">
		<d2l-labs-menu-item-ai text="Summarize with AI">
			<d2l-menu label="Summarize with AI">
				<d2l-menu-item text="Short summary"></d2l-menu-item>
			</d2l-menu>
		</d2l-labs-menu-item-ai>
	</d2l-menu>
`;

const disabledFixture = html`
	<d2l-menu label="Astronomy" style="width: 300px;">
		<d2l-labs-menu-item-ai text="Summarize with AI" disabled></d2l-labs-menu-item-ai>
	</d2l-menu>
`;

const longTextFixture = html`
	<d2l-menu label="Astronomy" style="width: 200px;">
		<d2l-labs-menu-item-ai text="Summarize this topic with AI so that the text wraps and eventually truncates"></d2l-labs-menu-item-ai>
	</d2l-menu>
`;

const singleLineFixture = html`
	<d2l-menu label="Astronomy" style="width: 200px;">
		<d2l-labs-menu-item-ai lines="1" text="Summarize this topic with AI so that the text truncates"></d2l-labs-menu-item-ai>
	</d2l-menu>
`;
...
describe('menu-item-ai', () => {
	...
	[
		...
		{ name: 'focus', template: defaultFixture, action: elem => focusElem(elem.querySelector('d2l-labs-menu-item-ai')) },
		{ name: 'hover', template: defaultFixture, action: elem => hoverElem(elem.querySelector('d2l-labs-menu-item-ai')) }
